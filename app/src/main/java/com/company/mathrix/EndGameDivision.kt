...
class EndGameDivision : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_end_game_division)

        tvMessageUser = findViewById(R.id.tvMessageUserDivision)
        tvFinalScore = findViewById(R.id.tvFinalScoreDivision)
        recycleView = findViewById(R.id.recycleViewDivision)
        btnPlayAgain = findViewById(R.id.btnPlayAgainDivision)
        btnExit = findViewById(R.id.btnExitDivision)
        ...
        highScoreUsers = FileHelperDivision.readData(this)
        ...
        FileHelperDivision.saveData(highScoreUsers, this)
    ...
    private fun getUserDataAndCreateUserObject() : User {
        name = intent.getStringExtra(Constants.USER_NAME_DIVISION)
        avatar = intent.getIntExtra(Constants.USER_AVATAR_DIVISION, R.drawable.alan_turing)
        score = intent.getIntExtra(Constants.USER_SCORE_DIVISION, 0)

        return User(name!!, avatar, score)
    }

    private fun showDialog() {
        val alertDialog = AlertDialog.Builder(this@EndGameDivision)
        ...
        alertDialog.setNegativeButton("No", DialogInterface.OnClickListener { dialogInterface, i ->
            ...
            val intent = Intent(this@EndGameDivision, OperationChooser::class.java)
        ...
        alertDialog.setPositiveButton("Yes", DialogInterface.OnClickListener { dialogInterface, i ->
            ...
            val intent = Intent(this@EndGameDivision, MainActivity::class.java)
            startActivity(intent)
            finish()
        })
