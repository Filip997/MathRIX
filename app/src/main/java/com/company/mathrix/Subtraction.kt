...
class Subtraction : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ivUserAvatar = findViewById(R.id.ivUserAvatarSubtraction)
        tvUserName = findViewById(R.id.tvUserNameSubtraction)
        tvUserLife = findViewById(R.id.tvUserLifeSubtraction)
        tvUserScore = findViewById(R.id.tvUserScoreSubtraction)
        tvTime = findViewById(R.id.tvTimeSubtraction)
        tvQuestion = findViewById(R.id.tvQuestionSubtraction)
        etAnswer = findViewById(R.id.etAnswerSubtraction)
        okButton = findViewById(R.id.btnOkSubtraction)
        nextButton = findViewById(R.id.btnNextQuestionSubtraction)
                    ...
                    if (userLife == 0) {
                        ...
                        val endingTimer: CountDownTimer = object : CountDownTimer(2000L, 1000L) {
                            ...
                            override fun onFinish() {
                                val intent = Intent(this@Subtraction, EndGameSubtraction::class.java)
                                intent.putExtra(Constants.USER_AVATAR_SUBTRACTION, userAvatar)
                                intent.putExtra(Constants.USER_NAME_SUBTRACTION, userName)
                                intent.putExtra(Constants.USER_SCORE_SUBTRACTION, userScore)
    ...
    private fun fillImageAndName() {
        userAvatar = intent.getIntExtra(Constants.USER_AVATAR_SUBTRACTION, R.drawable.alan_turing)
        userName = intent.getStringExtra(Constants.USER_NAME_SUBTRACTION)
