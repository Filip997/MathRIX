...
class EndGameMultiplication : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_end_game_multiplication)

        tvMessageUser = findViewById(R.id.tvMessageUserMultiplication)
        tvFinalScore = findViewById(R.id.tvFinalScoreMultiplication)
        recycleView = findViewById(R.id.recycleViewMultiplication)
        btnPlayAgain = findViewById(R.id.btnPlayAgainMultiplication)
        btnExit = findViewById(R.id.btnExitMultiplication)
        ...
        highScoreUsers = FileHelperMultiplication.readData(this)
        ...
        FileHelperMultiplication.saveData(highScoreUsers, this)
    ...
    private fun getUserDataAndCreateUserObject() : User {
        name = intent.getStringExtra(Constants.USER_NAME_MULTIPLICATION)
        avatar = intent.getIntExtra(Constants.USER_AVATAR_MULTIPLICATION, R.drawable.alan_turing)
        score = intent.getIntExtra(Constants.USER_SCORE_MULTIPLICATION, 0)

        return User(name!!, avatar, score)
    }

    private fun showDialog() {
        val alertDialog = AlertDialog.Builder(this@EndGameMultiplication)
        ...
        alertDialog.setNegativeButton("No", DialogInterface.OnClickListener { dialogInterface, i ->
            ...
            val intent = Intent(this@EndGameMultiplication, OperationChooser::class.java)
        ...
        alertDialog.setPositiveButton("Yes", DialogInterface.OnClickListener { dialogInterface, i ->
            ...
            val intent = Intent(this@EndGameMultiplication, MainActivity::class.java)
            startActivity(intent)
            finish()
        })
